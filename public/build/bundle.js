...
var app = (function () {
    ...
    */
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path_1, file$1, 40, 1, 1334);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(
    					...
    					"mousemove",
    					function () {
    						if (is_function(/*handleMousemove*/ ctx[2](/*data*/ ctx[8]))) /*handleMousemove*/ ctx[2](/*data*/ ctx[8]).apply(this, arguments);
    					},
    					false,
    					false,
    					false
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (!current || dirty & /*dataset*/ 1 && path_1_d_value !== (path_1_d_value = /*path*/ ctx[1](/*data*/ ctx[8]))) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(40:0) {#each dataset as data}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*path, dataset, quadInOut, handleMousemove*/ 7) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(svg, file, 22, 1, 507);
    			attr_dev(main, "class", "svelte-161625f");
    			add_location(main, file, 21, 0, 499);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ('dataset' in $$props) $$invalidate(0, dataset = $$props.dataset);
    		if ('nameList' in $$props) nameList = $$props.nameList;
    	};
