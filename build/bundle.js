    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(path_1, "d", path_1_d_value = /*path*/ ctx[1](/*data*/ ctx[6]));
    			attr_dev(path_1, "class", "svelte-13fpe9d");
    			add_location(path_1, file$1, 17, 1, 452);
    		},
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (!current || dirty & /*dataset*/ 1 && path_1_d_value !== (path_1_d_value = /*path*/ ctx[1](/*data*/ ctx[6]))) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(17:0) {#each dataset as data}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(svg, file, 20, 1, 385);
